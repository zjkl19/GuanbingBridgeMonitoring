function analyze_acceleration_points(root_dir, start_date, end_date, excel_file, subfolder)
...
for i = 1:numel(tpts)
    ...
    % 绘图
    plot_accel_curve(pid, times, vals, mn, mx);
end
...
function plot_accel_curve(pid, times, vals, mn, mx)
% 绘制加速度时程曲线及标注
