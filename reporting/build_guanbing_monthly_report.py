...
def apply_image_updates(doc: Document, result_root: Path, asset_dir: Path) -> tuple[list[dict], list[str]]:
    ...
    specs = [
        ...
        ("第2跨1/4跨", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G1_Orig"), 1, 145.0),
        ("第2跨1/2跨", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G2_Orig"), 1, 145.0),
        ("第2跨3/4跨", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G3_Orig"), 1, 145.0),
        ("第3跨1/4跨", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G4_Orig"), 1, 145.0),
        ("第3跨1/2跨", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G5_Orig"), 1, 145.0),
        ("第3跨3/4跨", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G6_Orig"), 1, 145.0),
        ("图 13 第2跨主梁位移变化趋势", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G2_Filt"), 1, 145.0),
        ("图 14 第3跨主梁位移变化趋势", find_latest_image(result_root, "时程曲线_挠度_组图", "Defl_G5_Filt"), 1, 145.0),
