% 设置CSV文件路径
file_path = 'F:\管柄数据\管柄6月数据\加速度\GB-VIB-G06-002-01.csv';
...
% 参数设置
start_time = '2025-06-25 00:30:27.039';
end_time = '2025-06-25 00:40:27.129';
sampling_rate = 100; % 采样频率为 100 Hz  重采样10
