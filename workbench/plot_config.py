...
PLOT_COMMON_SCHEMA: tuple[tuple[str, str, Any, str], ...] = (
    ...
    ("dynamic_raw_sampling_mode", "enum:capped|full", "capped", "高频原始图数据口径"),
    ("dynamic_raw_fig_max_points", "int", 50000, "高频图形渲染顶点总预算"),
    ("dynamic_raw_min_points_per_day", "int", 0, "每天图形最低渲染顶点预算"),
