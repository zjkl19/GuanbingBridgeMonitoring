...
RC3 candidate scope and still-pending validation are tracked in
`docs/releases/v1.8.0-rc3.md`; do not treat that candidate note as a completed
EXE release.
RC3 候选范围及尚未完成的验证见 `docs/releases/v1.8.0-rc3.md`；该候选说明不等于
EXE 已完成发布。
