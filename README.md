...
The stable `v1.8.2` scope, safeguards and promotion checks are recorded in
`docs/releases/v1.8.2.md`; the previous `v1.8.1` baseline remains recorded in
`docs/releases/v1.8.1.md`.
稳定版 `v1.8.2` 的功能范围、安全门槛和发布检查见
`docs/releases/v1.8.2.md`；上一稳定基线 `v1.8.1` 仍记录在
`docs/releases/v1.8.1.md`。
