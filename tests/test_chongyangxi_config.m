    ...
    methods (Test)
        function configMapsChongyangxiPoints(tc)
            ...
            tc.verifyEqual( ...
                ...
                cfg.plot_styles.deflection, defSpec, 'raw'), '时程曲线_主梁挠度_原始');
            tc.verifyEqual( ...
                bms.analyzer.StructuralFilteredSeriesPipeline.deflectionSingleOutputDir( ...
                cfg.plot_styles.deflection, defSpec, 'filtered'), '时程曲线_主梁挠度_滤波');
            tc.verifyEqual( ...
                bms.analyzer.StructuralFilteredSeriesPipeline.deflectionGroupOutputDir( ...
                cfg.plot_styles.deflection, defSpec, 'raw'), '时程曲线_主梁挠度_组图_原始');
            tc.verifyEqual( ...
                bms.analyzer.StructuralFilteredSeriesPipeline.deflectionGroupOutputDir( ...
                cfg.plot_styles.deflection, defSpec, 'filtered'), '时程曲线_主梁挠度_组图_滤波');
