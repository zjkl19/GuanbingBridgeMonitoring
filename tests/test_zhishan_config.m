classdef test_zhishan_config < matlab.unittest.TestCase
    ...
    methods (Test)
        function configMapsZhishanPointIds(tc)
            ...
            tc.verifyEqual([cfg.per_point.strain.SX_1.thresholds.min], -100);
            tc.verifyEqual([cfg.per_point.strain.SX_1.thresholds.max], 100);
            ...
            tc.verifyEqual([cfg.per_point.strain.SX_3.thresholds.min], -100);
            tc.verifyEqual([cfg.per_point.strain.SX_3.thresholds.max], 100);
            tc.verifyEqual([cfg.per_point.strain.SX_5.thresholds.min], -100);
            tc.verifyEqual([cfg.per_point.strain.SX_5.thresholds.max], 100);
            tc.verifyEqual(cfg.per_point.strain.SX_5.thresholds.t_range_end, '2026-06-30 23:59:59');
            tc.verifyEqual([cfg.per_point.strain.SX_6.thresholds.max], 100);
            tc.verifyEqual([cfg.per_point.strain.SX_7.thresholds.max], 100);
            tc.verifyEqual([cfg.per_point.strain.SX_8.thresholds.max], 100);
            ...
            tc.verifyEqual([lowSx8.min], -100);
            tc.verifyEqual([lowSx8.max], 100);
            lowSx10 = resolve_post_filter_thresholds(cfg, 'dynamic_strain_lowpass', 'SX-10');
            tc.verifyEqual([lowSx10.max], 100);

            tc.verifyEqual([cfg.defaults.acceleration.thresholds.min], [-0.2, -0.3]);
            tc.verifyEqual([cfg.defaults.acceleration.thresholds.max], [0.2, 0.3]);
            tc.verifyEqual({cfg.defaults.acceleration.thresholds.t_range_start}, {'2026-03-01 00:00:00', '2026-04-01 00:00:00'});
            tc.verifyEqual({cfg.defaults.acceleration.thresholds.t_range_end}, {'2026-03-31 23:59:59', '2026-06-30 23:59:59'});
            ...
            tc.verifyEqual([cfg.per_point.bearing_displacement.DX_1.thresholds.min], [-100, -35]);
            tc.verifyEqual([cfg.per_point.bearing_displacement.DX_1.thresholds.max], [100, 35]);
            ...
            tc.verifyEqual([cfg.per_point.bearing_displacement.DX_2.thresholds.min], [-100, -35]);
            tc.verifyEqual([cfg.per_point.bearing_displacement.DX_2.thresholds.max], [100, 35]);
