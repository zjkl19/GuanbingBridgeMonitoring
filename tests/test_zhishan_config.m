classdef test_zhishan_config < matlab.unittest.TestCase
    ...
    methods (Test)
        function configMapsZhishanPointIds(tc)
            ...
            tc.verifyEqual([cfg.per_point.strain.SX_5.thresholds.max], 405);
            ...
            tc.verifyEqual(cfg.per_point.cable_accel.CF_3.offset_correction.value, 29000);
            tc.verifyEqual(cfg.per_point.cable_accel.CF_4.offset_correction.value, 29000);
            tc.verifyEqual(cfg.per_point.cable_accel.CF_5.offset_correction.value, 29000);
            ...
            tc.verifyEqual([cfg.per_point.cable_accel.CF_1.thresholds.min], [-500, -3000]);
            tc.verifyEqual([cfg.per_point.cable_accel.CF_1.thresholds.max], [500, 3000]);
            tc.verifyEqual([cfg.per_point.cable_accel.CF_5.thresholds.min], [-100, -3000]);
            tc.verifyEqual([cfg.per_point.cable_accel.CF_5.thresholds.max], [140, 3000]);
