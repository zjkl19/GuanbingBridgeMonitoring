    ...
    methods (Static)
        ...
        function profiles = fallback(projectRoot)
            ...
            profiles = [ ...
                ...
                P('hongtang', '洪塘大桥', fullfile(projectRoot, 'config', 'hongtang_config.json'), fullfile(projectRoot, 'reports', '洪塘大桥健康监测2026年第一季季报-改4.docx'), 'hongtang_period', 'period', {'lowfreq_sync','strain','tilt','bearing_displacement','cable_accel','acceleration','wind','earthquake','wim'}), ...
                P('jiulongjiang', '九龙江大桥', fullfile(projectRoot, 'config', 'jiulongjiang_config.json'), fullfile(projectRoot, 'reports', '九龙江大桥健康监测2026年3月份月报_0508.docx'), 'jlj_daily_export', 'monthly', {'temperature','humidity','rainfall','wind','earthquake','deflection','bearing_displacement','tilt','acceleration','accel_spectrum','cable_accel','cable_accel_spectrum','crack','gnss','strain'}), ...
        ...
        function profile = infer(cfg, dataRoot)
            ...
            elseif contains(source, 'hongtang') || contains(source, '洪塘') ...
                    || contains(vendor, 'hongtang') || contains(rootText, '洪塘')
