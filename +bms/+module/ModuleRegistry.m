    ...
    methods (Static)
        function specs = catalog()
            ...
            specs = [ ...
                ...
                S('strain','doStrain',char([24212 21464 20998 26512]),'strain_stats.xlsx', 'analysis', 'SubfolderKey', 'strain', 'ReportEnabled', true, 'GuiLabel', '🧱 应变分析'), ...
                S('dynamic_strain_highpass','doDynStrainBoxplot',char([21160 24212 21464 20998 26512 65288 39640 36890 43 21547 31665 32447 22270 65289]),'dynamic_strain_highpass_stats.xlsx', 'analysis', 'SubfolderKey', 'strain', 'ReportEnabled', true, 'GuiLabel', '〰 动应变分析（高通+箱线图）', 'PresetField', 'dynbox'), ...
                S('dynamic_strain_lowpass','doDynStrainLowpassBoxplot',char([21160 24212 21464 20998 26512 65288 20302 36890 43 21547 31665 32447 22270 65289]),'dynamic_strain_lowpass_stats.xlsx', 'analysis', 'SubfolderKey', 'strain', 'ReportEnabled', true, 'GuiLabel', '〰 动应变分析（低通+箱线图）', 'PresetField', 'dynlowpass'), ...
