    ...
    methods
        ...
        function summary = run(obj)
            ...
            try
                ...
                runtimePlotOpts = bms.plot.PlotService.runtimeOptionsFromConfig(obj.Config);
                fprintf('Dynamic raw sampling: mode=%s, group=%s, render=%s, emf_disabled=%d\n', ...
                    bms.analyzer.DynamicSeriesService.rawSamplingMode(obj.Config, 'capped'), ...
                    bms.analyzer.DynamicAccelerationSeriesService.groupSamplingMode(obj.Config), ...
                    bms.analyzer.DynamicSeriesService.rawPlotRenderMode(obj.Config, 'line'), ...
                    ~runtimePlotOpts.save_emf);
